...
let quote = `"Cricket is a game played by 11 fools and watched by 11,000 fools"`;
console.log(`${author} one said, ${quote}`);
//  <=======================>
//   <==== #Assignments 5 Famous Quote 2 ====>
let famousPerson = `George Bernard Shaw`;
let message1 = `${famousPerson} once said,"Cricket is a game played by 11 fools and watched by 11,000 fools"`;
...
// Method 1:
let friendNames1 = ['Zane', 'Micheal', 'Dave', 'John'];
...
let GuestList1 = ['Zane', 'Micheal', 'Dave', 'John'];
let randomguest0 = Math.floor(Math.random() * GuestList1.length);
console.log(`\nOh no looks like ${GuestList1[randomguest0]} wont be able to have  dinner at my place.\n`);
let newInvitee0 = 'Mike';
...
let GuestList2 = ['Zane', 'Micheal', 'Dave', 'John'];
let randomguest1 = Math.floor(Math.random() * (GuestList2.length));
let newInvitee1 = 'Mike';
...
console.log('\n');
let moreGuest0 = ["Williams", "Chad", "Henry"];
...
let GuestList3 = ['Zane', 'Micheal', 'Dave', 'John'];
let randomguest2 = Math.floor(Math.random() * (GuestList3.length));
let newInvitee2 = 'Mike';
GuestList3[randomguest2] = newInvitee2;
let moreGuest1 = ["Williams", "Chad", "Henry"];
...
for (let i = -GuestList3.length; GuestList3.length > 2; i++) {
    let index = Math.floor(Math.random() * (GuestList3.length));
...
let placestovisit = ['Japan', 'Rome', 'Barcelona', 'New York', 'London'];
//Original Array:
...
let GuestList = ['Zane', 'Micheal', 'Dave', 'John'];
let randomguest = Math.floor(Math.random() * (GuestList.length));
let newInvitee = 'Mike';
GuestList[randomguest] = newInvitee;
let moreGuest = ["Williams", "Chad", "Henry"];
...
for (let i = -GuestList.length; GuestList.length > 2; i++) {
    let index = Math.floor(Math.random() * (GuestList.length));
...
let country0 = ["China", "india", "Japan", "Pakistan", "Saudia Arab"];
...
const country1 = ["China", "india", "Japan", "Pakistan", "Saudia Arab"];
...
let array = ["China", "india", "Japan", "Pakistan", "Saudia Arab"];
...
let favorite_fruits = ["Watermelon", "Apple", "Grapes", "bananas", "Dates"];
...
let profiles1 = ['Zane', 'Micheal', 'Admin', 'Dave', 'John'];
...
const pizzas0 = ["Pepperoni", "Margarita", "Cheese"];
...
const pizzas = ["Cat", "Chinchilla", "Hamsters"];
...
function make_Shirt(size = 'Large', print = "I love TYPESCRIPT!") {
    console.log(`Shirt Size: ${size}, With  Print: "${print}"`);
}
make_Shirt();
make_Shirt("Medium");
...
function describe_city(cityname, citycountry = "China") {
...
function make_album(artist_name, album_title, trackNumber) {
...
let magiciansNames0 = ["   HaRry houDIni    ", "David Blaine", "Derren Brown"];
function showMagician0(array) {
...
let magiciansNames1 = ["   HaRry houDIni    ", "David Blaine", "Derren Brown"];
function make_Great1(array) {
