...
console.log(Math.floor(Math.random()*(GuestList.length-1)))
// let randomguest:number=Math.floor(Math.random()*(GuestList.length-1))
// console.log(`Oh no looks like ${GuestList[randomguest]}, wont be able to have  dinner at my place.`);
//  <=======================>
//  <====  #Assignments 16 ====>
//  <=======================>
//  <====  #Assignments 17 ====>
